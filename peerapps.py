...
class MyTaskBarIcon(wx.TaskBarIcon):
    def __init__(self, frame):
        ...
        self.Bind(wx.EVT_MENU, self.GoToPeerMarket, id=2)
    ...
    def GoToPeerMarket(self, event):
        webbrowser.open("http://127.0.0.1:8011/peermarket.html")
